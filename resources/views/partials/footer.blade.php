<footer style="position: relative;">
        ...
        <div class="container text-white">
            <div class="row">
                <div class="col-md-4 col-lg-3 footer-about wow fadeInUp animated"
                    style="visibility: visible; animation-name: fadeInUp; z-index: 2;">
                    <a class="navbar-brand" href="#"><span>Lipesc</span>Ro</a>
                    <p>
                ...
                <div class="col-md-4 col-lg-4 offset-lg-1 footer-contact wow fadeInDown animated"
                    style="visibility: visible; animation-name: fadeInDown; z-index: 2;">
                    <h3>Contact</h3>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-md-6 footer-copyright" style="z-index: 2;">
                    © Bootstrap Footer Template by <a href="https://azmind.com">AZMIND</a>
                </div>
                <div class="col-md-6 footer-social" style="z-index: 2;">
    ...
    <div class="footer-background" style="z-index: 0;">
        <img src="https://placeimg.com/2000/400/arch" class="blur">
    </div>
</footer>